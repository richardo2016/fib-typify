...
const fibTypifyModule = require('./module')
const defaultSourceMapInstallScriptName = path.resolve(__dirname, './runtime/source-map-install.js')
...
function compileCallback (buf, args, tsCompilerOptions) {
   let tsScriptString = buf + ''
    ...
    const compiledModule = fibTypifyModule.compileModule(tsScriptString, {
